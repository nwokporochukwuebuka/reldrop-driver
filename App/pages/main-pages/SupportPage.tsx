    ...
    >
      <TouchableOpacity onPress={onPress} style={styles.card2}>
        <View style={styles.card}>
          <Padlock />
          <Text style={styles.sub}>FAQs</Text>
        </View>
        <ArrowRight />
      </TouchableOpacity>
      <TouchableOpacity onPress={onPress} style={styles.card2}>
        <View style={styles.card}>
          ...
          <View>
            ...
            <Text style={styles.sub}>support@reldrop.com</Text>
          </View>
        </View>
        <ArrowRight />
      </TouchableOpacity>
      <TouchableOpacity onPress={onPress} style={styles.card2}>
        <View style={styles.card}>
          <Padlock />
          <View>
            <Text style={styles.title}>Call a support officer</Text>
            <Text style={styles.sub}>0909999838</Text>
          </View>
        </View>
        <ArrowRight />
      </TouchableOpacity>
